...
const { getTemplateByIdController } = await import(
  "../../../src/controllers/SupervisorControllers/reportTemplate.js"
);

describe("get template by id", () => {
  test("The template has been successfully fetched", async () => {
    ...
    await getTemplateByIdController(req, res);
  ...
  test("The template was not fetched because supervisor ID is missing", async () => {
    const req = {
      user: {},
      params: { templateID: "1" },
    };
  ...
  test("The template was not fetched because templateID is missing", async () => {
    const req = {
      user: { id: 111222333 },
      params: {},
    };
  ...
  test("The template was not found", async () => {
    templateModel.getTemplateById.mockResolvedValue([]);
  ...
  test("The template was not successfully fetched", async () => {
    templateModel.getTemplateById.mockRejectedValue(new Error("DB failed"));
